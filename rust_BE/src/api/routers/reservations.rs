...
pub fn router() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route(
            ...
            axum::routing::post(add_payment_to_reservation),
        )
        .route(
            "/reservations/:reservation_id/tickets",
            axum::routing::post(link_ticket_to_reservation).get(get_tickets_for_reservation),
        )
        .route(
            "/reservations/create-payment-intent",
            axum::routing::post(create_payment_intent),
        )
        .route(
            "/reservations/create-with-payment",
            axum::routing::post(create_reservation_with_payment),
        )
        .route(
        ...
        .route(
            ...
            axum::routing::post(create_payment_link_checkout),
        )
}

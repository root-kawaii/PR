...
use crate::controllers::club_owner_controller::{
    ...
    get_my_club_events, get_my_club_images, get_my_club_tables, get_owner_stats_handler,
    get_table_images_handler, scan_code_handler, update_my_club, update_reservation_status_handler,
};
...
pub fn router() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/owner/events/:event_id/reservations/manual", axum::routing::post(create_manual_reservation_handler))

...
use crate::controllers::club_controller::{create_club, delete_club, get_all_clubs, get_club, update_club};
use crate::controllers::genre_controller::{create_genre, delete_genre, get_all_genres, get_genre, update_genre};
